...
export function Header({ isSpeaking, onStopSpeaking }: HeaderProps) {
  return (
    <header className="bg-gradient-to-r from-[#6B5FD4] via-[#7C5FD4] to-[#8D6AD8] text-white px-5 py-4 flex items-center justify-between relative z-10 shadow-md">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-semibold">万能营销</h1>
          <div className="flex items-center gap-1.5 mt-0.5">
            <span className="w-2 h-2 bg-green-400 rounded-full"></span>
            <span className="text-xs text-white/90">在线</span>
          </div>
        </div>
      </div>
