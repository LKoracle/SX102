...
export function MemberCard({ data }: MemberCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-red-200 shadow-sm overflow-hidden">
      <div className="bg-gradient-to-r from-red-500 to-red-400 px-4 py-2">
      ...
      <div className="p-3">
        <div className="grid grid-cols-2 gap-2 mb-2">
          <div className="bg-gray-50 rounded-lg p-2 text-center">
            ...
            <p className="text-lg font-bold text-red-500">{achieveRate}%</p>
        ...
        {member.issues && member.issues.length > 0 && (
          <div className="bg-red-50 rounded-lg p-2">
            <p className="text-xs font-medium text-red-700 mb-1">⚠️ 问题诊断：</p>
