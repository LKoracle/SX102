    ...
    <div className="bg-white rounded-[20px] border border-gray-100 shadow-sm overflow-hidden">
      ...
      <div className="p-2 space-y-2">
        {customers.map((customer, index) => (
          ...
          >
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center text-white font-bold text-[15px] flex-shrink-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1">
                <span className="text-[13px] bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full">
                  {customer.tag}
                </span>
