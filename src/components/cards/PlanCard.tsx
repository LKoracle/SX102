        ...
        {items.map((item, index) => (
          <div key={index}>
            <div className="flex items-center gap-2.5 mb-2">
              <span className="w-7 h-7 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 text-white text-[13px] flex items-center justify-center font-bold shadow-sm shadow-blue-200/30">
                {index + 1}
              </span>
              <span className="text-[15px] font-semibold text-gray-900">{item.week}</span>
            </div>
