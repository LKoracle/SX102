        ...
        aiMessages: [
          {
            ...
            speechText: '张经理，已为您生成本周工作总结。你如果想查看薄弱环节分析，可以试着对我说查看薄弱环节分析',
          },
          {
            type: 'work-summary',
            content: '',
        ...
        aiMessages: [
          {
            ...
            speechText: '本周促成动作和异议处理是短板，以赵高为例：客户担心资金流动性，但未成功引导。你如果想查看学习建议，可以试着对我说查看学习建议',
          },
          {
            type: 'ability-analysis',
            content: '',
        ...
        aiMessages: [
          {
            ...
            speechText: '已为您推荐针对性学习内容，建议本周内完成。你如果想查看收入激励提醒，可以试着对我说查看收入激励提醒',
          },
          {
            type: 'learning-plan',
            content: '',
        ...
        aiMessages: [
          {
            ...
            speechText: '已为您筛选3位高潜力客户，建议下周重点拜访。你如果想将客户加入拜访计划，可以试着对我说好的，加入计划',
          },
          {
            type: 'customer-list',
            content: '',
        ...
        aiMessages: [
          {
            ...
            speechText: '张经理，月度复盘报告出炉，本月超额完成目标，表现优秀！你如果想查看需提升技能，可以试着对我说查看需提升技能',
          },
          {
            type: 'work-summary',
            content: '',
        ...
        aiMessages: [
          {
            ...
            speechText: '根据本月数据，以下技能仍有提升空间。你如果想查看下月提升计划，可以试着对我说查看下月提升计划',
          },
          {
            type: 'ability-analysis',
            content: '',
